...
const TRANSFER_STATUS_TRANSITIONS = {
    ...
    [TRANSFER_STATUS.FORWARDED_TO_HPG]: [TRANSFER_STATUS.UNDER_REVIEW, TRANSFER_STATUS.APPROVED, TRANSFER_STATUS.REJECTED, TRANSFER_STATUS.COMPLETED], // Can complete directly when all org approvals are done
