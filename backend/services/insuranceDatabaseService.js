// TrustChain LTO - Insurance Database Service
// Backend wrapper for Insurance Database verification
// In production, this would connect to the actual insurance database API

class InsuranceDatabaseService {
    constructor() {
    ...
    lookupVehicle(vehicleData) {
        ...
        console.log('[Insurance DB] Lookup:', { normalizedPlate, normalizedEngine, normalizedChassis, normalizedPolicy });
        ...
        if (problemMatch) {
            const statusMessages = {
                ...
                'EXPIRED': 'EXPIRED: Insurance policy has expired',
        ...
        if (validMatch) {
            ...
            if (isExpired) {
                return {
                    ...
                    record: validMatch,
                    message: 'Insurance policy has EXPIRED - Renewal required',
                    canApprove: false,
                    details: {
...
module.exports = new InsuranceDatabaseService();
